        ...
        {showCreateResume && (
          ...
          >
            ...
            <input
              ...
              className="w-full px-4 py-2 mb-4 focus:border-cyan-600 ring-cyan-600"
              required
            />
        ...
        {showUploadResume && (
          ...
          >
            ...
            <div>
              ...
              >
                Select Resume File
                <div className="flex flex-col items-center justify-center gap-2 border group text-slate-400 border-slate-400 border-dashed rounded-md p-4 py-10 my-4 hover:border-cyan-500 hover:text-cyan-700 cursor-pointer transition-colors">
                  {resumeFile ? (
                    <p className="text-cyan-700">{resumeFile.name}</p>
                  ) : (
                    <>
            ...
            <button
              disabled={isLoading}
              className="w-full py-2 bg-cyan-600 text-white rounded hover:bg-cyan-700 transition-colors flex items-center justify-center gap-2"
            >
              {isLoading && (
