        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <hr
                className="absolute top-0 left-0 h-1 bg-gradient-to-r from-cyan-500 to-cyan-600 border-none transition-all duration-200"
                style={{
              ...
              <button
                ...
                className="bg-gradient-to-br from-cyan-100 to-cyan-200 ring-cyan-300 text-gray-600 ring hover:ring-cyan-400 transition-all rounded-md px-6 py-2 mt-6 text-sm"
              >
                Save Changes
              </button>
            </div>
            ...
            <div className="relative w-fill">
              ...
              <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  bg-gradient-to-br from-green-100 to-cyan-200 text-cyan-600 rounded-lg ring-cyan-300 hover:ring transition-colors"
                >
