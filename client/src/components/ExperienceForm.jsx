...
//                   }}
//                   className="rounded border-r-gray-300 text-blue-300 focus:ring-blue-300"
//                 />
...
//                       !experience.company
//                     }
//                     className="flex itc gap-1 px-2 py-2 text-xs bg-purple-200 text-purple-700 rounded hover:bg-purple-300 transition-colors disabled:opacity-50"
//                   >
//                     {generatingIndex === index ? (
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-3">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Company Name"
                  className="px-3 py-2 text-sm rounded-lg border border-blue-300 focus:ring-blue-200 focus:border-blue-400 outline-none"
                />
                ...
                <input
                  ...
                  type="month"
                  disabled={experience.is_current}
                  className="px-3 py-2 text-sm rounded-lg border border-blue-300 focus:ring-blue-200 focus:border-blue-400 outline-none disabled:bg-gray-100"
                />
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex gap-1 px-2 py-2 text-xs bg-purple-200 text-purple-700 rounded hover:bg-purple-300 transition-colors disabled:opacity-50"
                  >
                    {generatingIndex === index ? (
                      <Loader2 className="w-3 h-3 animate-spin" />
                    ) : (
                ...
                <textarea
                  ...
                  className="w-full text-sm px-3 py-2 rounded-lg resize-none border border-transparent focus:border-blue-300 focus:ring-blue-200"
                  placeholder="Describe your key responsibilities and achievements..."
                />
              </div>
            </div>
