...
const Footer = () => {
  ...
  return (
    <>
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-[rgb(185,238,245)]/60 to-white mt-40">
        ...
        <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
          ...
          <div>
            <p className="text-slate-800 font-semibold">Product</p>
            <ul className="mt-2 space-y-2">
              <li><a href="/" className="hover:text-[rgb(185,238,245)]">Home</a></li>
              <li><a href="/" className="hover:text-[rgb(185,238,245)]">Support</a></li>
              <li><a href="/" className="hover:text-[rgb(185,238,245)]">Pricing</a></li>
              <li><a href="/" className="hover:text-[rgb(185,238,245)]">Affiliate</a></li>
            </ul>
          </div>
          ...
          <div>
            <p className="text-slate-800 font-semibold">Resources</p>
            <ul className="mt-2 space-y-2">
              <li><a href="/" className="hover:text-[rgb(185,238,245)]">Company</a></li>
              <li><a href="/" className="hover:text-[rgb(185,238,245)]">Blogs</a></li>
              <li><a href="/" className="hover:text-[rgb(185,238,245)]">Community</a></li>
              <li>
                <a href="/" className="hover:text-[rgb(185,238,245)]">
                  Careers
                  <span className="ml-2 px-2 py-0.5 text-xs text-white bg-[rgb(185,238,245)] rounded">
                    We’re hiring!
                  </span>
                </a>
              </li>
              <li><a href="/" className="hover:text-[rgb(185,238,245)]">About</a></li>
            </ul>
          </div>
          ...
          <div>
            <p className="text-slate-800 font-semibold">Legal</p>
            <ul className="mt-2 space-y-2">
              <li><a href="/" className="hover:text-[rgb(185,238,245)]">Privacy</a></li>
              <li><a href="/" className="hover:text-[rgb(185,238,245)]">Terms</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
          ...
          <p className="mt-3 text-center">
            © {currentYear}{" "}
            <a
              href="https://github.com/KhushiManjare"
              target="_blank"
              rel="noreferrer"
              className="hover:text-[rgb(185,238,245)]"
            >
              Made By Khushi Manjare
            </a>
          </p>
        </div>
      </footer>
