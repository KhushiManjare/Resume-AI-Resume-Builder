...
const Testimonials = () => {
  ...
  return (
    ...
    >
      {/* Badge */}
      <div className="flex items-center gap-2 text-sm text-[#0F766E] bg-[#0F766E]/10 rounded-full px-6 py-1.5">
        <BookUserIcon width={14} className="size-4.5 stroke-[#0F766E]" />
        <span>Testimonials</span>
      </div>
      ...
      <div className="w-full mx-auto max-w-5xl overflow-hidden relative">
        ...
        <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10 bg-gradient-to-l from-white to-transparent"></div>
      </div>
