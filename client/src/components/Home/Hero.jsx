  ...
  return (
    <div className="bg-[#F8FAFC]">
      <div className="min-h-screen pb-20">
        ...
        {/* ================= NAVBAR ================= */}
        <nav className="z-50 flex items-center justify-between w-full py-4 px-4 md:px-10 lg:px-24 xl:px-40 text-sm text-[#0F172A]">
          
          {/* 🔥 TEXT LOGO */}
          <Link to="/" className="flex items-center gap-1">
            <span className="text-3xl font-bold tracking-wide text-[#454a58]">
              Resu
              <span className="text-[#0F766E]">Me</span>
            </span>
          </Link>

          <div className="hidden md:flex items-center gap-8">
            <a href="/" className="hover:text-[#0F766E]">Home</a>
            <a href="#features" className="hover:text-[#0F766E]">Features</a>
            <a href="#testimonials" className="hover:text-[#0F766E]">Testimonials</a>
            <a href="#cta" className="hover:text-[#0F766E]">Contact</a>
          </div>
          ...
          <div className="flex gap-2 items-center">
            <Link
              to="/app?state=register"
              hidden={user}
              className="hidden md:block px-6 py-2 bg-[#0F766E] hover:bg-[#115E59] rounded-full text-white"
            >
              Get Started
            </Link>
            ...
            <Link
              to="/app?state=login"
              hidden={user}
              className="hidden md:block px-6 py-2 border rounded-full hover:bg-slate-100"
            >
              Login
            </Link>
            ...
            <Link
              to="/app"
              hidden={!user}
              className="hidden md:block px-8 py-2 bg-[#0F766E] hover:bg-[#115E59] rounded-full text-white"
            >
              Dashboard
            </Link>
          </div>
        ...
        {/* ================= HERO CONTENT ================= */}
        <div className="relative flex flex-col items-center text-center px-4 md:px-16 lg:px-24 xl:px-40 text-[#0F172A]">

          {/* Glow */}
          <div className="absolute top-24 -z-10 left-1/4 size-96 bg-[#0F766E]/10 blur-[120px]" />
          ...
          <div className="flex items-center mt-10 gap-3">
            <div className="flex -space-x-3">
              ...
              <img src="https://randomuser.me/api/portraits/men/75.jpg" className="w-8 h-8 rounded-full border-2 border-white" />
            </div>

            <div className="flex items-center ml-2">
              {Array(5).fill(0).map((_, i) => (
                <svg key={i} width="16" height="16" fill="currentColor" className="text-[#0F766E]">
                  <path d="M12 2l2.5 5 5.5.8-4 4 .9 5.4-4.9-2.6-4.9 2.6.9-5.4-4-4 5.5-.8z" />
                </svg>
              ))}
              <p className="ml-2 text-sm text-[#475569]">
                Used by <span className="font-medium">10,000+</span> users
              </p>
            </div>
          </div>
          ...
          <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl mt-6 leading-tight">
            Land your dream job with{" "}
            <span className="bg-gradient-to-r from-[#0F766E] to-[#115E59] bg-clip-text text-transparent">
              AI-powered
            </span>{" "}
            resumes.
          </h1>

          <p className="max-w-md mt-6 text-[#475569]">
          ...
          <div className="flex gap-4 mt-6">
            <Link
              to="/app"
              className="bg-[#0F766E] hover:bg-[#115E59] text-white rounded-full px-9 h-12 flex items-center"
            >
              Get Started →
            </Link>
            <button className="border rounded-full px-7 h-12 hover:bg-slate-100">
              Try Demo
            </button>
          </div>

          {/* Brand Logos */}
          <p className="py-8 text-[#475569] mt-10">
            Trusted by leading brands, including
          </p>

          <div className="flex flex-wrap justify-center gap-8 max-w-3xl mx-auto">
            {logos.map((l, i) => (
              <img key={i} src={l} alt="Company logo" className="h-6 opacity-80" />
            ))}
          </div>
        </div>
      </div>
