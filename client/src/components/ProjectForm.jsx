            ...
            >
              ...
              <div className="grid gap-3">
                ...
                <input
                  ...
                  className="px-3 py-2 text-sm rounded-lg border border-cyan-300 focus:outline-none focus:ring-1 focus:ring-cyan-300"
                />
                ...
                <input
                  ...
                  className="px-3 py-2 text-sm rounded-lg border border-cyan-300 focus:outline-none focus:ring-1 focus:ring-cyan300"
                />
                ...
                <input
                  ...
                  className="px-3 py-2 text-sm rounded-lg border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-300"
                />
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 text-sm rounded-lg resize-none border border-cyan-300 focus:outline-none focus:ring-1 focus:ring-cyan-300"
                />
              </div>
            </div>
          ))
